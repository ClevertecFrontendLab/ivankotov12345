...
export const Terms = () =>  (
    <section className={styles.list}>
      <h1 className={styles.header}>Правила пользования</h1>
      <ol className={styles.list_top}>
        <li className={styles.list_main}>
          ...
          <ol className={styles.list_paragraph_1}>
          <li className={styles.list_paragraph}>
        ...
        <ol className={styles.list_paragraph_1}>
          <li className={styles.list_paragraph}>
            ...
            <ol className={styles.list_paragraph_2}>
            <li className={styles.list_paragraph}>
            ...
            <li className={styles.final_list}>
        ...
        <ol className={styles.list_paragraph_1}>
          ...
          <li className={styles.final_list}>
            ...
            <ol className={styles.list_paragraph_2}>
              ...
              <ol className={styles.list_paragraph_3}>
                <li className={styles.list_paragraph}>
                ...
                <li className={styles.final_list}>
                  3.3.1.2Прежде всего, разбавленное изрядной долей эмпатии, рациональное мышление однозначно фиксирует необходимость новых предложений. Являясь всего лишь частью общей картины, независимые государства представлены в исключительно положительном свете.
                </li>
              </ol>
              </li>
            </ol> 
